...
public static class ScenesList
{
    ...
    public static void Assets_GamePrototype_OtherScenes_Charpter1_1_unity() { ScenesUpdate.OpenScene("Assets/GamePrototype/OtherScenes/Charpter1 1.unity"); }
    ...
    public static void Assets_GamePrototype_OtherScenes_Charpter4_unity() { ScenesUpdate.OpenScene("Assets/GamePrototype/OtherScenes/Charpter4.unity"); }
    [MenuItem("Scenes/DialogSystem_Prototype")]
    public static void Assets_GamePrototype_OtherScenes_DialogSystem_Prototype_unity() { ScenesUpdate.OpenScene("Assets/GamePrototype/OtherScenes/DialogSystem_Prototype.unity"); }
    [MenuItem("Scenes/SpriteMask_Prototype")]
    public static void Assets_GamePrototype_OtherScenes_SpriteMask_Prototype_unity() { ScenesUpdate.OpenScene("Assets/GamePrototype/OtherScenes/SpriteMask_Prototype.unity"); }
}
#endif
